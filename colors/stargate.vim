...
hi Normal guifg=#f8f8f2 ctermfg=255 guibg=#110010 ctermbg=232 gui=NONE cterm=NONE
hi Comment guifg=#6272a4 ctermfg=61 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi Constant guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi String guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Character guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Function guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi PreProc guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Structure guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Typedef guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Special guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=italic cterm=italic
...
hi SignColumn guifg=NONE ctermfg=NONE guibg=#110010 ctermbg=232 gui=NONE cterm=NONE
...
hi DiffAdd guifg=#1e1e1e ctermfg=234 guibg=#ffa4c6 ctermbg=218 gui=NONE cterm=NONE
...
hi IncSearch guifg=#fffea2 ctermfg=229 guibg=#6272a4 ctermbg=61 gui=NONE cterm=NONE
...
hi QuickFixLine guifg=#1e1e1e ctermfg=234 guibg=#fffea2 ctermbg=229 gui=NONE cterm=NONE
hi Search guifg=#1e1e1e ctermfg=234 guibg=#fffea2 ctermbg=229 gui=NONE cterm=NONE
...
hi SpellCap guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi SpellLocal guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi SpellRare guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TabLineFill guifg=NONE ctermfg=NONE guibg=#110010 ctermbg=232 gui=NONE cterm=NONE
...
hi WarningMsg guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSString guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSStringEscape guifg=#8be9fd ctermfg=117 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSCharacter guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSFloat guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSAnnotation guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSFunction guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSFuncMacro guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSMethod guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi htmlArg guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi htmlBold guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi htmlLink guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi htmlSpecialChar guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi markdownBlockquote guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi markdownBold guifg=#ffe4fa ctermfg=225 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi markdownCode guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi markdownItalic guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=italic cterm=italic
...
hi CocExplorerBufferNameVisible guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi StartifySelect guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi StartifyHeader guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi StartifySection guifg=#c4a4f9 ctermfg=183 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi StartifyFooter guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi WhichKey guifg=#c4a4f9 ctermfg=183 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi WhichKeySeperator guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi diffAdded guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi diffRemoved guifg=#ff5555 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi diffFileId guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=bold,reverse cterm=bold,reverse
hi diffFile guifg=#3b4048 ctermfg=238 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi diffNewFile guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi VimwikiHeader2 guifg=#ffa4c6 ctermfg=218 guibg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi VimwikiHeader5 guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi VimwikiHR guifg=#fffea2 ctermfg=229 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
